...
const About = () => (
    <OuterContainer>
        <Container>
            ...
            <Description>I primarily work on the MERN stack: React, Node, Firebase, Serverless, Express, Next.js, Vercel, Gatsby, GraphQL, MongoDB.</Description>
            <Description>I love working on Side Projects such as <a href="https://www.tvdl.app" target="_blank">TVDL</a> and I am currently working on <a href="https://github.com/saifalfalah/ssyd-api" target="_blank">SSYD</a> combining Web Assembly and React.</Description>
